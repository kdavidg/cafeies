...
DATABASES = {
    'default': {
        ...
        'CLIENT': {
            'host': 'mongodb://localhost:27017/', # O tu cadena de conexión de Mongo Atlas
        }
    }
}
...
DEFAULT_AUTO_FIELD = 'django.db.models.AutoField' # Cambia BigAutoField por AutoField para mayor compatibilidad con Djongo
